...
import { Icon, SolidIcon } from "@/components/elements/Icon";

/* Brand tokens (match Header / Footer / landing page) ---------------- */
/* heading navy #132743 · accent pink #d73853 · card surface #f1f5f9   */

/* The glyph helpers now live in the element kit; re-exported so the many
   `@/web/common/Primitives` call sites keep working unchanged.            */
export { Icon, SolidIcon };
